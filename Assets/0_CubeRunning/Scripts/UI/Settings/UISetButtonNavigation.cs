...
{
    UIGenericButton[] genericButtons = default;
    UISettingItemFiller[] listSettingItems = default;
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < listSettingItems.Length; i++)
        {
            ...
            newNavigation.selectOnLeft =
                listSettingItems[i].gameObject.GetComponent<MultiInputButton>().navigation.selectOnLeft;
            newNavigation.selectOnRight = listSettingItems[i].gameObject.GetComponent<MultiInputButton>().navigation
                .selectOnRight;
            ...
            listSettingItems[i].SetNagivetion(buttonToSelectOnDown, buttonToSelectOnUp);
        }
    }
