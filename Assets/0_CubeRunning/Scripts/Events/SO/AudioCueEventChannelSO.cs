...
public class AudioCueEventChannelSO : DescriptionBaseSO
{
    ...
    public AudioCueKey RaisePlayEvent(AudioCueSO audioCue, AudioConfigurationSO audioConf,
        Vector3 positionInSpace = default)
    {
        ...
        {
            audioCueKey = OnAudioCuePlayRequested.Invoke(audioCue, audioConf, positionInSpace);
        }
        else
        {
